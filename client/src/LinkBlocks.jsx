...
class LinkBlocks extends React.Component {
    ...
    render() {
        let list = this.state.linkList
        let links = list.map((link) => {
        return <div className="individual-link d-flex flex-column justify-content-center w-25 p-1 m-1 border border-dark">
        ...
        <input value={link.title} type="text" placeholder="Title" className="border-0 m-1 p-1 d-flex"
            onChange={(e) => {
        ...
        <input value={link.url} type="url" placeholder="Url" className="border-0 m-1 p-1"
            onChange={(e) => {
        ...
        <div onClick={() => this.onDeleteLink(link.id)} 
        className="d-flex justify-content-end m-2 p-1">
        ...
        return <div className="d-flex flex-column">
            ...
            <div className="outer-linkbox d-flex flex-column justify-center align-items-center mt-3">
                ...
                <button onClick={() => this.onSave()} type="button" className="btn btn-primary btn-rounded d-flex m-1 px-5 w-auto">Save</button>
